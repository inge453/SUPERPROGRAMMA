...
Public Class Form1
    ...
    Private Sub PictureBox1_DragDrop(ByVal sender As System.Object, ByVal e As System.Windows.Forms.DragEventArgs) Handles SurfaceSKin0.DragDrop
        ...
        sf0(0) = droppedFiles(0)
    End Sub

    Private Sub PictureBox2_DragEnter(ByVal sender As System.Object, ByVal e As System.Windows.Forms.DragEventArgs) Handles sf0_normal.DragEnter
        If e.Data.GetDataPresent(DataFormats.FileDrop, False) = True Then
            e.Effect = DragDropEffects.All
        End If
    End Sub
    ...
    Function genera_materiale2(ByRef surf As String()) As String
        ...
        res = res + "material texture " + quote + "Texture/" + Path.GetFileName(surf(0)) + quote + vbCrLf + "{" + vbCrLf

        If surf(Normal) <> "" Then
            res = res + "normal " + quote + "Texture/" + Path.GetFileNameWithoutExtension(surf(0)) + "_normal" + Path.GetExtension(surf(1)) + quote + vbCrLf
        End If

        If surf(Metallic) <> "" Then
            res = res + "metallic " + quote + "Texture/" + Path.GetFileNameWithoutExtension(surf(0)) + "_metallic" + Path.GetExtension(surf(2)) + quote + vbCrLf
        End If

        If surf(Roughness) <> "" Then
            res = res + "roughness " + quote + "Texture/" + Path.GetFileNameWithoutExtension(surf(0)) + "_roughness" + Path.GetExtension(surf(3)) + quote + vbCrLf
        End If

        If surf(AO) <> "" Then
            res = res + "ao " + quote + "Texture/" + Path.GetFileNameWithoutExtension(surf(0)) + "_ao" + Path.GetExtension(surf(4)) + quote + vbCrLf
        End If
    ...
    Function genera_gldef(ByVal copia As Boolean)
        ...
        If (sf0(Normal) <> "") And (sf0(Metallic) <> "") And (sf0(AO) <> "") And (sf0(Roughness) <> "") Then
            ...
            If copia = True Then
                File.Copy(sf0(Normal), cartella + "\Texture\" + Path.GetFileNameWithoutExtension(sf0(0)) + "_normal" + Path.GetExtension(sf0(Normal)))
                File.Copy(sf0(Roughness), cartella + "\Texture\" + Path.GetFileNameWithoutExtension(sf0(0)) + "_roughness" + Path.GetExtension(sf0(Roughness)))
                File.Copy(sf0(Metallic), cartella + "\Texture\" + Path.GetFileNameWithoutExtension(sf0(0)) + "_metallic" + Path.GetExtension(sf0(Metallic)))
                File.Copy(sf0(AO), cartella + "\Texture\" + Path.GetFileNameWithoutExtension(sf0(0)) + "_ao" + Path.GetExtension(sf0(AO)))
            End If
        End If
        If (sf1(Normal) <> "") And (sf1(Metallic) <> "") And (sf1(AO) <> "") And (sf1(Roughness) <> "") Then
            RichTextBox3.AppendText(genera_materiale2(sf1))
            If copia = True Then
                File.Copy(sf1(Normal), cartella + "\Texture\" + Path.GetFileNameWithoutExtension(sf1(0)) + "_normal" + Path.GetExtension(sf1(Normal)))
                File.Copy(sf1(Roughness), cartella + "\Texture\" + Path.GetFileNameWithoutExtension(sf1(0)) + "_roughness" + Path.GetExtension(sf1(Roughness)))
                File.Copy(sf1(Metallic), cartella + "\Texture\" + Path.GetFileNameWithoutExtension(sf1(0)) + "_metallic" + Path.GetExtension(sf1(Metallic)))
                File.Copy(sf1(AO), cartella + "\Texture\" + Path.GetFileNameWithoutExtension(sf1(0)) + "_ao" + Path.GetExtension(sf1(AO)))
            End If
        End If
        If (sf2(Normal) <> "") And (sf2(Metallic) <> "") And (sf2(AO) <> "") And (sf2(Roughness) <> "") Then
            RichTextBox3.AppendText(genera_materiale2(sf2))
            If copia = True Then
                File.Copy(sf2(Normal), cartella + "\Texture\" + Path.GetFileNameWithoutExtension(sf2(0)) + "_normal" + Path.GetExtension(sf2(Normal)))
                File.Copy(sf2(Roughness), cartella + "\Texture\" + Path.GetFileNameWithoutExtension(sf2(0)) + "_roughness" + Path.GetExtension(sf2(Roughness)))
                File.Copy(sf2(Metallic), cartella + "\Texture\" + Path.GetFileNameWithoutExtension(sf2(0)) + "_metallic" + Path.GetExtension(sf2(Metallic)))
                File.Copy(sf2(AO), cartella + "\Texture\" + Path.GetFileNameWithoutExtension(sf2(0)) + "_ao" + Path.GetExtension(sf2(AO)))
            End If
        End If
        If (sf3(Normal) <> "") And (sf3(Metallic) <> "") And (sf3(AO) <> "") And (sf3(Roughness) <> "") Then
            RichTextBox3.AppendText(genera_materiale2(sf3))
            If copia = True Then
                File.Copy(sf3(Normal), cartella + "\Texture\" + Path.GetFileNameWithoutExtension(sf3(0)) + "_normal" + Path.GetExtension(sf3(Normal)))
                File.Copy(sf3(Roughness), cartella + "\Texture\" + Path.GetFileNameWithoutExtension(sf3(0)) + "_roughness" + Path.GetExtension(sf3(Roughness)))
                File.Copy(sf3(Metallic), cartella + "\Texture\" + Path.GetFileNameWithoutExtension(sf3(0)) + "_metallic" + Path.GetExtension(sf3(Metallic)))
                File.Copy(sf3(AO), cartella + "\Texture\" + Path.GetFileNameWithoutExtension(sf3(0)) + "_ao" + Path.GetExtension(sf3(AO)))
            End If
        End If
        If (sf4(Normal) <> "") And (sf4(Metallic) <> "") And (sf4(AO) <> "") And (sf4(Roughness) <> "") Then
            RichTextBox3.AppendText(genera_materiale2(sf4))
            If copia = True Then
                File.Copy(sf4(Normal), cartella + "\Texture\" + Path.GetFileNameWithoutExtension(sf3(0)) + "_normal" + Path.GetExtension(sf4(Normal)))
                File.Copy(sf4(Roughness), cartella + "\Texture\" + Path.GetFileNameWithoutExtension(sf3(0)) + "_roughness" + Path.GetExtension(sf4(Roughness)))
                File.Copy(sf4(Metallic), cartella + "\Texture\" + Path.GetFileNameWithoutExtension(sf3(0)) + "_metallic" + Path.GetExtension(sf4(Metallic)))
                File.Copy(sf4(AO), cartella + "\Texture\" + Path.GetFileNameWithoutExtension(sf3(0)) + "_ao" + Path.GetExtension(sf4(AO)))
            End If
        End If
        If (sf5(Normal) <> "") And (sf5(Metallic) <> "") And (sf5(AO) <> "") And (sf5(Roughness) <> "") Then
            RichTextBox3.AppendText(genera_materiale2(sf5))
            If copia = True Then
                File.Copy(sf5(Normal), cartella + "\Texture\" + Path.GetFileNameWithoutExtension(sf3(0)) + "_normal" + Path.GetExtension(sf5(Normal)))
                File.Copy(sf5(Roughness), cartella + "\Texture\" + Path.GetFileNameWithoutExtension(sf3(0)) + "_roughness" + Path.GetExtension(sf5(Roughness)))
                File.Copy(sf5(Metallic), cartella + "\Texture\" + Path.GetFileNameWithoutExtension(sf3(0)) + "_metallic" + Path.GetExtension(sf5(Metallic)))
                File.Copy(sf5(AO), cartella + "\Texture\" + Path.GetFileNameWithoutExtension(sf3(0)) + "_ao" + Path.GetExtension(sf5(AO)))
            End If
        End If
    End Function
End Class
